...
import org.jetbrains.research.kotopunter.util.unquote
...
object AddressExporter {
    ...
    fun main(args: Array<String>) {
        val pw = PrintWriter("kotopunter-js/src/main/ts/util/kotopunter-generated.ts")
