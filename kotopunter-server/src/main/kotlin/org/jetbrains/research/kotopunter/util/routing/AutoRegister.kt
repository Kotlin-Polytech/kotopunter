...
fun Router.autoRegisterHandlers(routingConfig: RoutingConfig) {
    val log = LoggerFactory.getLogger("org.jetbrains.research.kotopunter.AutoRegisterHandlers")
    ...
    Reflections("org.jetbrains.research.kotopunter", MethodAnnotationsScanner())
    ...
    Reflections("org.jetbrains.research.kotopunter", TypeAnnotationsScanner(), SubTypesScanner())
