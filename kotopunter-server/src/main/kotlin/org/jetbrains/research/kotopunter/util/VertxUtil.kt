...
fun autoDeploy(vertx: Vertx, handler: Handler<AsyncResult<CompositeFuture>>) {
    val log = LoggerFactory.getLogger("org.jetbrains.research.kotopunter.AutoDeploy")
    val fs = Reflections("org.jetbrains.research.kotopunter", TypeAnnotationsScanner(), SubTypesScanner())
